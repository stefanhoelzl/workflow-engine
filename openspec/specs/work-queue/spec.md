...
Provide a blocking in-memory work queue that buffers pending events for the scheduler, supporting both runtime event ingestion and startup bootstrap recovery, with cancellable dequeue operations.
