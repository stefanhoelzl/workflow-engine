...
- **AND** no other configuration file in the repository (`Dockerfile`, GitHub Actions, `pnpm-workspace.yaml`, contributor docs) SHALL declare a different pnpm version
