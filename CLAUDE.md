...
- **NEVER** use the reserved event prefixes `trigger`, `action`, `fetch`, `mail`, `sql`, `timer`, `console`, `wasi`, or `uncaught-error` for third-party plugins; use a domain-specific prefix instead (§2 R-7).
